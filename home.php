    ...
    <body>
        <div id="page">
            ...
            <ul class="nav nav-pills">
                <li role="presentation" class="active"><a href="home.php">
                ...
                if ($row->active == 0) {
                    echo"
                        <tr>
                            ...
                            <td>$row->title</td>
                            <td>$row->author</td>
                            <td><a href='home.php?box=active&id={$row->id}'>Active</a></td>
                            <td>
                                <a href='home.php?box=edite&id={$row->id}'><span class='glyphicon glyphicon-cog' 
                                    aria-hidden='true'> </a> &
                                <a href='home.php?box=delete&id={$row->id}'><span class='glyphicon glyphicon-remove-circle' 
                                    aria-hidden='true'></a>
                            </td> 
                        </tr>
                   ";
                    ...
                    <tr>
                        ...
                        <td>$row->title</td>
                        <td>$row->author</td>
                        <td><a href='home.php?box=unactive&id={$row->id}'>Un Active</a></td>
                        <td>
                            <a href='home.php?box=edite&id={$row->id}'><span class='glyphicon glyphicon-cog' 
                                aria-hidden='true'> </a> &
                            <a href='home.php?box=delete&id={$row->id}'><span class='glyphicon glyphicon-remove-circle' 
        ...
        <!-- Start footer -->
        <footer>
            copyright &copy;  2017 Mohamed Elfert &trade;
        </footer>
        <!-- End footer -->
